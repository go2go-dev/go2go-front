...
export class ErrorBoundary extends Component<
	StrictPropsWithChildren & ErrorBoundaryProps,
	State
> {
	hasError = false;

	constructor(props: StrictPropsWithChildren & ErrorBoundaryProps) {
		super(props);
	...
	render() {
		...
		return (
			<ErrorboundaryProvider value={ErrorboundaryProviderProps}>
				{renderedChildren}
